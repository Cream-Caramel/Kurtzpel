...
namespace Client
{
	...
	enum ANIMMODELPASS {ANIM_DEFAULT, ANIM_PATTERN, ANIM_HIT, ANIM_FINISH, ANIM_PLAYERVOID, ANIM_DISSOLVE, ANIM_END};
	enum MODELPASS {MODEL_DEFAULT, MODEL_NONLIGHT, MODEL_DISSOLVE, MODEL_STARTDISSOLVE, MODEL_END};
