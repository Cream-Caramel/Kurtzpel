...
namespace Client
{
	...
	enum MODELPASS {MODEL_DEFAULT, MODEL_NDEFAULT, MODEL_NONLIGHT, MODEL_ENDDISSOLVE, MODEL_NENDDISSOLVE, MODEL_STARTDISSOLVE, MODEL_NSTARTDISSOLVE, MODEL_HIT, MODEL_NHIT, MODEL_END};
