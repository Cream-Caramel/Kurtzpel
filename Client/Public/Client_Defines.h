...
namespace Client
{
	...
	enum ANIMMODELPASS {ANIM_DEFAULT, ANIM_PATTERN, ANIM_HIT, ANIM_FINISH, ANIM_PLAYERVOID, ANIM_END};
	enum SOUND {SD_PLAYER1, SD_PLAYER2, SD_PLAYERVOICE, SD_PLAYERSKILL1, SD_PLAYERSKILL2, SD_MONSTER, SD_UI, SD_SYSTEM, SD_BGM, SD_END};
