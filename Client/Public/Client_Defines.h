...
namespace Client
{
	...
	enum ANIMMODELPASS {ANIM_DEFAULT, ANIM_NDEFAULT, ANIM_PATTERN, ANIM_NPATTERN, ANIM_HIT, ANIM_NHIT, ANIM_FINISH, ANIM_NFINISH, ANIM_DISSOLVE, ANIM_NDISSOLVE, ANIM_END};
	...
	enum EFFECTPASS {EFFECT_DEFAULT, EFFECT_NDEFAULT, EFFECT_END};
