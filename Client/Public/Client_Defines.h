...
namespace Client
{
	...
	enum ANIMMODELPASS {ANIM_DEFAULT, ANIM_NDEFAULT, ANIM_PATTERN, ANIM_NPATTERN, ANIM_HIT, ANIM_NHIT, ANIM_FINISH, ANIM_NFINISH, ANIM_DISSOLVE, ANIM_NDISSOLVE
		, ANIM_GOLEMPATTERN, ANIM_SHADOW, ANIM_END};
	enum MODELPASS {MODEL_DEFAULT, MODEL_NDEFAULT, MODEL_NONLIGHT, MODEL_ENDDISSOLVE, MODEL_NENDDISSOLVE, MODEL_STARTDISSOLVE, MODEL_NSTARTDISSOLVE
		, MODEL_HIT, MODEL_NHIT, MODEL_SHADOW, MODEL_END};
	enum INSTANCEPASS {INSTANCEMODEL_DEFAULT, INSTANCEMODEL_NDEFAULT, INSTANCEMODEL_SHADOW, INSTANCEMODEL_END};
