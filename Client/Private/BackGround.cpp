...
HRESULT CBackGround::Initialize(void * pArg)
{
	...
	XMStoreFloat4x4(&m_ProjMatrix, XMMatrixTranspose(XMMatrixOrthographicLH((float)g_iWinSizeX, (float)g_iWinSizeY, 0.f, 1.f)));
...
HRESULT CBackGround::Ready_Components()
{
	...
	/* For.Com_Texture */
	if (FAILED(__super::Add_Component(LEVEL_GAMEPLAY, TEXT("Prototype_Component_Texture_Default"), TEXT("Com_Texture"), (CComponent**)&m_pTextureCom)))
		return E_FAIL;
