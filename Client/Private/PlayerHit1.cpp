...
HRESULT CPlayerHit1::Initialize(void * pArg)
{
	...
	/*_vector t = { PM->Get_BossPos().x, PM->Get_BossPos().y , PM->Get_BossPos().z, 1.f };
	m_pTransformCom->Set_State(CTransform::STATE_POSITION, t);*/
	//m_pTransformCom->Set_State(CTransform::STATE_POSITION, XMLoadFloat4(&m_PlayerHit1Info.vWorldPos));
	return S_OK;
}
