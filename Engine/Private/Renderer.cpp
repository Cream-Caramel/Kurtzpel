...
HRESULT CRenderer::Initialize_Prototype()
{
	...
	if (FAILED(m_pTarget_Manager->Initialize_Debug(TEXT("Target_Diffuse"), 75.f, 150.f, 150.f, 150.f)))
		return E_FAIL;
	if (FAILED(m_pTarget_Manager->Initialize_Debug(TEXT("Target_Normal"), 75.f, 300.f, 150.f, 150.f)))
		return E_FAIL;
	if (FAILED(m_pTarget_Manager->Initialize_Debug(TEXT("Target_Shade"), 75.f, 450.f, 150.f, 150.f)))
		return E_FAIL;
