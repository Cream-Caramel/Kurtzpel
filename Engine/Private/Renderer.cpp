...
HRESULT CRenderer::Initialize_Prototype()
{
	...
	if (FAILED(m_pTarget_Manager->Initialize_Debug(TEXT("Target_Depth"), 75.f, 500.f, 150.f, 150.f)))
		return E_FAIL;
	if (FAILED(m_pTarget_Manager->Initialize_Debug(TEXT("Target_Shade"), ViewportDesc.Width - 75, 100.f, 150.f, 150.f)))
		return E_FAIL;
	if (FAILED(m_pTarget_Manager->Initialize_Debug(TEXT("Target_Specular"), ViewportDesc.Width - 75, 300.f, 150.f, 150.f)))
		return E_FAIL;
